...
def train(modeln, parameter_dict):
    checkpoint_directory = "GAN_training/training_checkpoints_emrwgan_"+modeln
    ...
    manager = tf.train.CheckpointManager(checkpoint, directory=checkpoint_directory, max_to_keep=50)
